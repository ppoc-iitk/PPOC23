...
<div className="grid-gallery">
  ...
  <div className="grid-item">
    <a href="Gallery/img4.jpg" target="_blank" data-lightbox="gridImage">
      <img src="Gallery/img4.jpg" loading="lazy" alt='gallery-img'/>
    </a>
  </div>
  <div className="grid-item">
    <a href="Gallery/img5.jpg" target="_blank" data-lightbox="gridImage">
      <img src="Gallery/img5.jpg" loading="lazy" alt='gallery-img'/>
    </a>
  </div>
  <div className="grid-item">
  ...
  <div className="grid-item">
    <a href="Gallery/img8.jpeg" target="_blank" data-lightbox="gridImage">
      <img src="Gallery/img8.jpeg" loading="lazy" alt='gallery-img'/>
    </a>
  </div>
  <div className="grid-item">
    <a href="Gallery/img10.jpg" target="_blank" data-lightbox="gridImage">
      <img src="Gallery/img10.jpg" loading="lazy" alt='gallery-img'/>
    </a>
  </div>
  <div className="grid-item">
    <a href="Gallery/img9.jpg" target="_blank" data-lightbox="gridImage">
      <img src="Gallery/img9.jpg" loading="lazy" alt='gallery-img'/>
    </a>
  </div>
  
  <div className="grid-item">
    <a href="Gallery/img11.jpg" target="_blank" data-lightbox="gridImage">
      <img src="Gallery/img11.jpg" loading="lazy" alt='gallery-img'/>
    </a>
  </div>
  <div className="grid-item">
    <a href="Gallery/img15.jpg" target="_blank" data-lightbox="gridImage">
      <img src="Gallery/img15.jpg"loading="lazy" alt='gallery-img'/>
    </a>
  </div>
  <div className="grid-item">
    <a href="Gallery/img14.jpg" target="_blank" data-lightbox="gridImage">
      <img src="Gallery/img14.jpg"loading="lazy" alt='gallery-img'/>
    </a>
  </div>
  <div className="grid-item">
    <a href="Gallery/img13.jpg" target="_blank" data-lightbox="gridImage">
      <img src="Gallery/img13.jpg"loading="lazy" alt='gallery-img'/>
    </a>
  </div>
  <div className="grid-item">
    <a href="Gallery/img16.jpeg" target="_blank" data-lightbox="gridImage">
      <img src="Gallery/img16.jpeg"loading="lazy" alt='gallery-img'/>
    </a>
  </div>
  <div className="grid-item">
    <a href="Gallery/img17.jpg" target="_blank" data-lightbox="gridImage">
      <img src="Gallery/img17.jpg"loading="lazy" alt='gallery-img'/>
    </a>
  </div>
  <div className="grid-item">
